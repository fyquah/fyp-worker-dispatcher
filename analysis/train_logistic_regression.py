...
def codegen_model(
    ...
    f.write("    ~numeric_feature_indices ~bool_feature_indices\n")
    f.write("    ~numeric_feature_means ~numeric_feature_std\n")
    f.write("  in\n")
    f.write("  let output = \n")
    f.write("    Tf_lib.matmul (Tf_lib.Vec weights) Tf_lib.features\n")
    f.write("    |> Tf_lib.add (Tf_lib.Scalar intercept)\n")
    f.write("  in\n")
    f.write("  [| 1.0 -. output; output; |]\n")
    f.write(";;")
