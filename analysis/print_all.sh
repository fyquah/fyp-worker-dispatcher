...
for problem in $PROBLEMS; do
  ...
  echo "./print_linear_general_reward_without_normalisation.sh out-$VERSION/$problem &>tmp/$VERSION-$problem-print-linear-general-reward-without-normalisation.log" >>$TASK_FILE
done
